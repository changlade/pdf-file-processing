...
exe = EXE(
    ...
    target_arch=None,  # Use current architecture for compatibility
...
app = BUNDLE(
    ...
    icon=None,
    bundle_identifier='com.pdfexplorer.semanticsearch',
    info_plist={
        ...
        'LSArchitecturePriority': ['arm64', 'x86_64'],  # Apple Silicon first, then Intel
        'LSRequiresNativeExecution': False,  # Allow Rosetta if needed
        'CFBundleIdentifier': 'com.pdfexplorer.semanticsearch',
        'CFBundleName': 'PDF Document Explorer',
        'CFBundleExecutable': 'PDF Document Explorer',
        'CFBundlePackageType': 'APPL',
        'CFBundleSignature': 'PDFS',
        ...
        'LSMinimumSystemVersionByArchitecture': {
            'arm64': '11.0.0',  # Apple Silicon minimum
